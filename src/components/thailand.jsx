import ThailandBg from '../assets/thailand/thailandBg.jpg';
    ...
    return(
        <section>
           ...
           <div className="md:flex justify-around ">
                ...
                <div className="flex mt-3 p-2 flex-wrap h-10 rounded-full bg-gradient-to-r from-green-400 to-orange-500 hover:from-pink-500 hover:to-yellow-500">
                    <span className="mt-1 px-4" ><FiPhoneCall /></span>
                    <button><a href="#">Request Call Back</a></button>
                </div>
            </div>
            <img className="md:w-full md:h-[500px]" src={ThailandBg} alt="" />
